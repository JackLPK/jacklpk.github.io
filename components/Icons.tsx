/* 
  Icons and colors for icons

  TODO (optional):
  - move from inline SVG to next/image style 
  E.g.
  import SVGIcon1 from "../assets/images/something.svg"
  ...
  <Image src={SVGIcon1} alt="..." width={150} height={150} className="md:h-w-52 m-10 md:w-52" />
*/

export const TWITTER_COLOR = "#1da1f2"
export const LINKEDIN_COLOR = "#0077b5"
export const GITHUB_COLOR = "#FFF"
